...
def double_spherical_bessel_plan(
    ...
    *,
    ...
    half_width : int
        ...
        ``half_width`` grid points of ``chi``. It sets which pairs are
    ...
    dropped::
        ...
        pp = double_spherical_bessel_plan(ell, n, dlog=dlog, bias=0.5, half_width=m)
        kern = forward(a, pp)
        i = jnp.arange(m, n - m)
    ...
    return product_plan(first, second, half_width=half_width)
